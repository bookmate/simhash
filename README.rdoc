...
You can split string how you like: by letters, by sentences, by specific letter-combinations, etc.
...
But if you have {GNU MP library}[http://gmplib.org/], simhash will work faster! To check out what version used, type:
